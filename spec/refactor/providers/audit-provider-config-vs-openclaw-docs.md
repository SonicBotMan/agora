...
| 位置 | 硬编码值 | 应替换为 |
|---|---|---|
| 第 762 行 | `'agora-server'` | `ProviderName.LobsteraiServer` |
| 第 770 行 | `'agora-server'` | `ProviderName.LobsteraiServer` |
| 第 778 行 | `'openai-completions'` | `OpenClawApi.OpenAICompletions` (cast) |
| 第 785 行 | `'agora-server'` | `OpenClawProviderId.LobsteraiServer` |
