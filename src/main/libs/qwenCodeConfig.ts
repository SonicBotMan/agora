...
const AGORA_ENV_KEY = {
  openai: 'AGORA_QWEN_OPENAI_API_KEY',
  anthropic: 'AGORA_QWEN_ANTHROPIC_API_KEY',
  gemini: 'AGORA_QWEN_GEMINI_API_KEY',
...
export const mergeQwenCodeConfigForAgoraModel = (
  ...
  const envKey = AGORA_ENV_KEY[authType];
  ...
  const nextEntry: QwenCodeModelProvider = {
    id: model,
    name: `${providerDisplayName(providerName || 'Agora')} ${model}`,
    envKey,
    baseUrl: config.baseURL,
    description: 'Configured by Agora.',
  };
