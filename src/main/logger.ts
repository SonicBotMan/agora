 ...
 *
 * Log file locations:
 *   macOS:   ~/Library/Logs/Agora/main-YYYY-MM-DD.log
 *   Windows: %USERPROFILE%\AppData\Roaming\Agora\logs\main-YYYY-MM-DD.log
 *   Linux:   ~/.config/Agora/logs/main-YYYY-MM-DD.log
 *
 * Rotation policy:
...
export function initLogger(): void {
  ...
  // Log startup marker
  log.info('='.repeat(60));
  log.info(`Agora started (${process.platform} ${process.arch})`);
  log.info('='.repeat(60));
}
